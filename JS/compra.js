...
$("#buttonTarjeta").click(() =>{
   ...
   $("body").append(
       ...
       <div class="row">
        <h3 class="text-center mb-4 titulo__seleccion">Ha seleccionado pagar en tarjeta!</h3>
       </div>
            <div class="row">
                <div class="col-6">
                    <div>
                ...
                <div class="col-6">
                    <form id="formularioTarjeta">
                        ...
                        <div class="mb-3 formulario__grupo">
                            ...
                            <div class="formulario__grupo-input">
                            <input type="name" class="formulario__input" id="nombreTitular" placeholder="Thomas Palacio">
                            </div>
                        </div>
                        <div class="mb-3 formulario__grupo">
